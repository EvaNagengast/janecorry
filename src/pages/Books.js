    ...
    <div>
      ...
      <div className="bookpage">
        ...
        <a
          ...
          target="_blank"
        >
          <img src={book6} alt="The lies we tell Book cover" className="book" />
        </a>
        ...
        <a
          ...
          target="_blank"
        >
          <img src={book5} alt="I made a Mistake Book cover" className="book" />
        </a>
        ...
        <a
          ...
          target="_blank"
        >
          <img src={book2} alt="The killing type Book cover" className="book" />
        </a>
